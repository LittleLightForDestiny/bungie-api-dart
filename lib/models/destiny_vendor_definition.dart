...
class DestinyVendorDefinition{
	...
	Map<String, dynamic> toMap(){
		Map<String, dynamic> data = new Map();
			...
			data['unlockRanges'] = this.unlockRanges.map((item)=>item.toMap());
			...
			data['actions'] = this.actions.map((item)=>item.toMap());
			data['categories'] = this.categories.map((item)=>item.toMap());
			data['originalCategories'] = this.originalCategories.map((item)=>item.toMap());
			data['displayCategories'] = this.displayCategories.map((item)=>item.toMap());
			data['interactions'] = this.interactions.map((item)=>item.toMap());
			data['inventoryFlyouts'] = this.inventoryFlyouts.map((item)=>item.toMap());
			data['itemList'] = this.itemList.map((item)=>item.toMap());
			data['services'] = this.services.map((item)=>item.toMap());
			data['acceptedItems'] = this.acceptedItems.map((item)=>item.toMap());
			data['returnWithVendorRequest'] = this.returnWithVendorRequest;
			data['locations'] = this.locations.map((item)=>item.toMap());
