class PlatformErrorCodes {
  ...
  static const int PerApplicationThrottleExceeded = 54;
  static const int PerApplicationAnonymousThrottleExceeded = 55;
  static const int PerApplicationAuthenticatedThrottleExceeded = 56;
  static const int PerUserThrottleExceeded = 57;
  ...
  static const int UserEmailMustBeVerified = 233;
  static const int UserMustAllowCustomerServiceEmails = 234;
  static const int NonTransactionalEmailSendFailure = 235;
  ...
  static const int LoyaltyRewardAlreadyRedeemed = 2057;
  static const int UnclaimedLoyaltyRewardEntryNotFound = 2058;
  ...
  static const int SteamWebApiError = 2900;
  static const int SteamWebNullResponseError = 2901;
  ...
  static const int CrossSaveMustMigrateToSteam = 3219;
  static const int CrossSaveSteamAlreadyPaired = 3220;
  static const int CrossSaveCannotPairJustSteamAndBlizzard = 3221;
  static const int CrossSaveCannotPairSteamAloneBeforeShadowkeep = 3222;
  static const int AuthVerificationNotLinkedToAccount = 3300;
  static const int PCMigrationMissingBlizzard = 3400;
  static const int PCMigrationMissingSteam = 3401;
  static const int PCMigrationInvalidBlizzard = 3402;
  static const int PCMigrationInvalidSteam = 3403;
  static const int PCMigrationUnknownFailure = 3404;
  static const int PCMigrationUnknownException = 3405;
  static const int PCMigrationNotLinked = 3406;
  static const int PCMigrationAccountsAlreadyUsed = 3407;
  static const int PCMigrationStepFailed = 3408;
  static const int PCMigrationInvalidBlizzardCrossSaveState = 3409;
  static const int PCMigrationDestinationBanned = 3410;
  static const int PCMigrationDestinyFailure = 3411;
  static const int PCMigrationSilverTransferFailed = 3412;
  static const int PCMigrationEntitlementTransferFailed = 3413;
  static const int UnsupportedBrowser = 3500;
}