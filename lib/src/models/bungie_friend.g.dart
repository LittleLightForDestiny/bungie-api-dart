...
BungieFriend _$BungieFriendFromJson(Map<String, dynamic> json) =>
    BungieFriend()
      ...
      ..lastSeenAsBungieMembershipType = decodeBungieMembershipType(
        json['lastSeenAsBungieMembershipType'],
      )
      ...
      ..onlineTitle =
          json['onlineTitle'] == null
              ? null
              : PresenceOnlineStateFlags.fromJson(
                (json['onlineTitle'] as num).toInt(),
              )
...
Map<String, dynamic> _$BungieFriendToJson(BungieFriend instance) =>
    <String, dynamic>{
      ...
      'lastSeenAsBungieMembershipType': encodeBungieMembershipType(
