...
class DestinyBreakerTypeDefinition{	
	...
	static Future<DestinyBreakerTypeDefinition> asyncFromJson(Map<String, dynamic> json) => 
		compute<Map<String, dynamic>, DestinyBreakerTypeDefinition>((json)=>DestinyBreakerTypeDefinition.fromJson(json), json);
