...
class DestinyRaceDefinition{	
	...
	static Future<DestinyRaceDefinition> asyncFromJson(Map<String, dynamic> json) => 
		compute<Map<String, dynamic>, DestinyRaceDefinition>((json)=>DestinyRaceDefinition.fromJson(json), json);
