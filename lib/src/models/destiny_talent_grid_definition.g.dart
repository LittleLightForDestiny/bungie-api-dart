    ...
    DestinyTalentGridDefinition()
      ...
      ..nodes =
          (json['nodes'] as List<dynamic>?)
              ?.map(
                (e) => DestinyTalentNodeDefinition.fromJson(
                  e as Map<String, dynamic>,
                ),
              )
              .toList()
      ..exclusiveSets =
          (json['exclusiveSets'] as List<dynamic>?)
              ?.map(
                (e) => DestinyTalentNodeExclusiveSetDefinition.fromJson(
                  e as Map<String, dynamic>,
                ),
              )
              .toList()
      ...
      ..groups = (json['groups'] as Map<String, dynamic>?)?.map(
        (k, e) => MapEntry(
          k,
          DestinyTalentExclusiveGroup.fromJson(e as Map<String, dynamic>),
        ),
      )
      ..nodeCategories =
          (json['nodeCategories'] as List<dynamic>?)
              ?.map(
                (e) => DestinyTalentNodeCategory.fromJson(
                  e as Map<String, dynamic>,
                ),
              )
              .toList()
...
Map<String, dynamic> _$DestinyTalentGridDefinitionToJson(
  ...
  'nodeCategories': instance.nodeCategories?.map((e) => e.toJson()).toList(),
  'hash': instance.hash,
