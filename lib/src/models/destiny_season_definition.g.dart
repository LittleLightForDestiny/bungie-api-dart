...
DestinySeasonDefinition _$DestinySeasonDefinitionFromJson(
    ...
    DestinySeasonDefinition()
      ...
      ..seasonPassList = (json['seasonPassList'] as List<dynamic>?)
          ?.map((e) =>
              DestinySeasonPassReference.fromJson(e as Map<String, dynamic>))
          .toList()
      ...
      ..acts = (json['acts'] as List<dynamic>?)
          ?.map((e) =>
              DestinySeasonActDefinition.fromJson(e as Map<String, dynamic>))
          .toList()
...
Map<String, dynamic> _$DestinySeasonDefinitionToJson(
    ...
    <String, dynamic>{
      ...
      'seasonPassList':
          instance.seasonPassList?.map((e) => e.toJson()).toList(),
