...
import '../enums/bucket_scope.dart';
import '../enums/bucket_category.dart';
...
class DestinyInventoryBucketDefinition{	
	...
	static Future<DestinyInventoryBucketDefinition> asyncFromJson(Map<String, dynamic> json) => 
		compute<Map<String, dynamic>, DestinyInventoryBucketDefinition>((json)=>DestinyInventoryBucketDefinition.fromJson(json), json);
