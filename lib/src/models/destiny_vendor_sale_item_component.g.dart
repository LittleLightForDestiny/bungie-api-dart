...
DestinyVendorSaleItemComponent _$DestinyVendorSaleItemComponentFromJson(
  Map<String, dynamic> json,
    ...
    DestinyVendorSaleItemComponent()
      ..saleStatus =
          json['saleStatus'] == null
              ? null
              : VendorItemStatus.fromJson((json['saleStatus'] as num).toInt())
      ..requiredUnlocks =
          (json['requiredUnlocks'] as List<dynamic>?)
              ?.map((e) => (e as num).toInt())
              .toList()
      ..unlockStatuses =
          (json['unlockStatuses'] as List<dynamic>?)
              ?.map(
                (e) => DestinyUnlockStatus.fromJson(e as Map<String, dynamic>),
              )
              .toList()
      ..failureIndexes =
      ...
      ..augments =
          json['augments'] == null
              ? null
              : DestinyVendorItemState.fromJson(
                (json['augments'] as num).toInt(),
              )
      ..itemValueVisibility =
          (json['itemValueVisibility'] as List<dynamic>?)
              ?.map((e) => e as bool)
              .toList()
...
Map<String, dynamic> _$DestinyVendorSaleItemComponentToJson(
  ...
  'unlockStatuses': instance.unlockStatuses?.map((e) => e.toJson()).toList(),
