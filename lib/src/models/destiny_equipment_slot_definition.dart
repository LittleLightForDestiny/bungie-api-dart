...
class DestinyEquipmentSlotDefinition{	
	...
	static Future<DestinyEquipmentSlotDefinition> asyncFromJson(Map<String, dynamic> json) => 
		compute<Map<String, dynamic>, DestinyEquipmentSlotDefinition>((json)=>DestinyEquipmentSlotDefinition.fromJson(json), json);
