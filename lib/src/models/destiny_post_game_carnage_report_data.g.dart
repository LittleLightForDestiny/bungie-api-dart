...
DestinyPostGameCarnageReportData _$DestinyPostGameCarnageReportDataFromJson(
  Map<String, dynamic> json,
    ...
    DestinyPostGameCarnageReportData()
      ...
      ..selectedSkullHashes =
          (json['selectedSkullHashes'] as List<dynamic>?)
      ...
      ..entries =
          (json['entries'] as List<dynamic>?)
              ?.map(
                (e) => DestinyPostGameCarnageReportEntry.fromJson(
      ...
      ..teams =
          (json['teams'] as List<dynamic>?)
              ?.map(
                (e) => DestinyPostGameCarnageReportTeamEntry.fromJson(
                  e as Map<String, dynamic>,
                ),
              )
              .toList();
...
Map<String, dynamic> _$DestinyPostGameCarnageReportDataToJson(
  ...
  'activityWasStartedFromBeginning': instance.activityWasStartedFromBeginning,
