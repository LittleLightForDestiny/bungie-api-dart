...
_$DestinyPresentationNodeChildrenBlockFromJson(Map<String, dynamic> json) =>
    DestinyPresentationNodeChildrenBlock()
      ..presentationNodes =
          (json['presentationNodes'] as List<dynamic>?)
              ?.map(
                (e) => DestinyPresentationNodeChildEntry.fromJson(
                  e as Map<String, dynamic>,
                ),
              )
              .toList()
      ..collectibles =
          (json['collectibles'] as List<dynamic>?)
              ?.map(
                (e) => DestinyPresentationNodeCollectibleChildEntry.fromJson(
                  e as Map<String, dynamic>,
                ),
              )
              .toList()
      ..records =
          (json['records'] as List<dynamic>?)
              ?.map(
                (e) => DestinyPresentationNodeRecordChildEntry.fromJson(
                  e as Map<String, dynamic>,
                ),
              )
              .toList()
      ..metrics =
          (json['metrics'] as List<dynamic>?)
              ?.map(
                (e) => DestinyPresentationNodeMetricChildEntry.fromJson(
                  e as Map<String, dynamic>,
                ),
              )
              .toList()
      ..craftables =
          (json['craftables'] as List<dynamic>?)
              ?.map(
                (e) => DestinyPresentationNodeCraftableChildEntry.fromJson(
                  e as Map<String, dynamic>,
                ),
              )
              .toList();
