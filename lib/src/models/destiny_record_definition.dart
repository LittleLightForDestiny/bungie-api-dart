...
class DestinyRecordDefinition{	
	...
	static Future<DestinyRecordDefinition> asyncFromJson(Map<String, dynamic> json) => 
		compute<Map<String, dynamic>, DestinyRecordDefinition>((json)=>DestinyRecordDefinition.fromJson(json), json);
