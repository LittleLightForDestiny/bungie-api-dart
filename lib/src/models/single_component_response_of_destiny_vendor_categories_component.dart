...
class SingleComponentResponseOfDestinyVendorCategoriesComponent{	
	...
	static Future<SingleComponentResponseOfDestinyVendorCategoriesComponent> asyncFromJson(Map<String, dynamic> json) => 
		compute<Map<String, dynamic>, SingleComponentResponseOfDestinyVendorCategoriesComponent>((json)=>SingleComponentResponseOfDestinyVendorCategoriesComponent.fromJson(json), json);
