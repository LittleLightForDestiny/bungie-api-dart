...
DestinyMilestone _$DestinyMilestoneFromJson(Map<String, dynamic> json) =>
    DestinyMilestone()
      ...
      ..availableQuests =
          (json['availableQuests'] as List<dynamic>?)
              ?.map(
                (e) =>
      ...
      ..activities =
          (json['activities'] as List<dynamic>?)
              ?.map(
                (e) => DestinyMilestoneChallengeActivity.fromJson(
      ...
      ..vendorHashes =
          (json['vendorHashes'] as List<dynamic>?)
      ...
      ..rewards =
          (json['rewards'] as List<dynamic>?)
              ?.map(
                (e) => DestinyMilestoneRewardCategory.fromJson(
                  e as Map<String, dynamic>,
                ),
              )
              .toList()
...
Map<String, dynamic> _$DestinyMilestoneToJson(
  DestinyMilestone instance,
) => <String, dynamic>{
  'milestoneHash': instance.milestoneHash,
  'availableQuests': instance.availableQuests?.map((e) => e.toJson()).toList(),
