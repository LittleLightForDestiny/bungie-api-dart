...
DestinyMilestone _$DestinyMilestoneFromJson(Map<String, dynamic> json) {
  return DestinyMilestone()
    ...
    ..availableQuests = (json['availableQuests'] as List<dynamic>?)
        ?.map((e) => DestinyMilestoneQuest.fromJson(e as Map<String, dynamic>))
        .toList()
    ...
    ..vendors = (json['vendors'] as List<dynamic>?)
        ?.map((e) => DestinyMilestoneVendor.fromJson(e as Map<String, dynamic>))
        .toList()
    ..rewards = (json['rewards'] as List<dynamic>?)
        ?.map((e) =>
            DestinyMilestoneRewardCategory.fromJson(e as Map<String, dynamic>))
        .toList()
