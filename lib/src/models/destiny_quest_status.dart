...
class DestinyQuestStatus{	
	...
	static Future<DestinyQuestStatus> asyncFromJson(Map<String, dynamic> json) => 
		compute<Map<String, dynamic>, DestinyQuestStatus>((json)=>DestinyQuestStatus.fromJson(json), json);
