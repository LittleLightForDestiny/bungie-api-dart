...
class SingleComponentResponseOfDestinyPlugSetsComponent{	
	...
	static Future<SingleComponentResponseOfDestinyPlugSetsComponent> asyncFromJson(Map<String, dynamic> json) => 
		compute<Map<String, dynamic>, SingleComponentResponseOfDestinyPlugSetsComponent>((json)=>SingleComponentResponseOfDestinyPlugSetsComponent.fromJson(json), json);
