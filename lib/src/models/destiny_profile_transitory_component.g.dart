...
DestinyProfileTransitoryComponent _$DestinyProfileTransitoryComponentFromJson(
  Map<String, dynamic> json,
    ...
    DestinyProfileTransitoryComponent()
      ..partyMembers =
          (json['partyMembers'] as List<dynamic>?)
              ?.map(
                (e) => DestinyProfileTransitoryPartyMember.fromJson(
                  e as Map<String, dynamic>,
                ),
              )
              .toList()
      ..currentActivity =
          json['currentActivity'] == null
              ? null
              : DestinyProfileTransitoryCurrentActivity.fromJson(
                json['currentActivity'] as Map<String, dynamic>,
              )
      ..joinability =
          json['joinability'] == null
              ? null
      ...
      ..tracking =
          (json['tracking'] as List<dynamic>?)
              ?.map(
                (e) => DestinyProfileTransitoryTrackingEntry.fromJson(
                  e as Map<String, dynamic>,
                ),
              )
              .toList()
