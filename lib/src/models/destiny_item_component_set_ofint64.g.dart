...
DestinyItemComponentSetOfint64 _$DestinyItemComponentSetOfint64FromJson(
  ...
  return DestinyItemComponentSetOfint64()
    ...
    ..reusablePlugs = json['reusablePlugs'] == null
        ? null
        : DictionaryComponentResponseOfint64AndDestinyItemReusablePlugsComponent.fromJson(json['reusablePlugs'] as Map<String, dynamic>)
    ..plugObjectives = json['plugObjectives'] == null ? null : DictionaryComponentResponseOfint64AndDestinyItemPlugObjectivesComponent.fromJson(json['plugObjectives'] as Map<String, dynamic>)
    ..talentGrids = json['talentGrids'] == null ? null : DictionaryComponentResponseOfint64AndDestinyItemTalentGridComponent.fromJson(json['talentGrids'] as Map<String, dynamic>)
    ...
    ..objectives = json['objectives'] == null ? null : DictionaryComponentResponseOfint64AndDestinyItemObjectivesComponent.fromJson(json['objectives'] as Map<String, dynamic>);
}
