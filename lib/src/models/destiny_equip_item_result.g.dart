...
DestinyEquipItemResult _$DestinyEquipItemResultFromJson(
  ...
  return DestinyEquipItemResult()
    ...
    ..equipStatus = _$enumDecodeNullable(
        _$PlatformErrorCodesEnumMap, json['equipStatus'],
        unknownValue: PlatformErrorCodes.None);
}
...
Map<String, dynamic> _$DestinyEquipItemResultToJson(
    ...
    <String, dynamic>{
      ...
      'equipStatus': _$PlatformErrorCodesEnumMap[instance.equipStatus],
    };
