...
import '../enums/destiny_stat_aggregation_type.dart';
import '../enums/destiny_stat_category.dart';
...
class DestinyStatDefinition{	
	...
	factory DestinyStatDefinition.fromJson(Map<String, dynamic> json) {
		return _$DestinyStatDefinitionFromJson(json);
	}
	
	Map<String, dynamic> toJson() => _$DestinyStatDefinitionToJson(this);

	static Future<DestinyStatDefinition> asyncFromJson(Map<String, dynamic> json) => 
		compute<Map<String, dynamic>, DestinyStatDefinition>((json)=>DestinyStatDefinition.fromJson(json), json);
