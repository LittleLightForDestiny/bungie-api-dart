...
HardLinkedUserMembership _$HardLinkedUserMembershipFromJson(
  Map<String, dynamic> json,
    ...
    HardLinkedUserMembership()
      ...
      ..crossSaveOverriddenType = decodeBungieMembershipType(
        json['CrossSaveOverriddenType'],
      )
...
Map<String, dynamic> _$HardLinkedUserMembershipToJson(
  ...
  'CrossSaveOverriddenType': encodeBungieMembershipType(
    instance.crossSaveOverriddenType,
  ),
  'CrossSaveOverriddenMembershipId': instance.crossSaveOverriddenMembershipId,
};
