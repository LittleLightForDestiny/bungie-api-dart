    ...
    ContentTypeDescription()
      ...
      ..properties =
          (json['properties'] as List<dynamic>?)
              ...
              .toList()
      ..tagMetadata =
          (json['tagMetadata'] as List<dynamic>?)
              ?.map(
                (e) =>
                    TagMetadataDefinition.fromJson(e as Map<String, dynamic>),
              )
              .toList()
      ..tagMetadataItems = (json['tagMetadataItems'] as Map<String, dynamic>?)
          ?.map(
            (k, e) => MapEntry(
              k,
      ...
      ..usageExamples =
          (json['usageExamples'] as List<dynamic>?)
              ?.map((e) => e as String)
              .toList()
      ...
      ..propertySections =
          (json['propertySections'] as List<dynamic>?)
              ?.map(
                (e) => ContentTypePropertySection.fromJson(
...
Map<String, dynamic> _$ContentTypeDescriptionToJson(
  ...
  'tagMetadataItems': instance.tagMetadataItems?.map(
