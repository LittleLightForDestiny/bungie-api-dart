...
DestinyRecordDefinition _$DestinyRecordDefinitionFromJson(
  Map<String, dynamic> json,
    ...
    DestinyRecordDefinition()
      ...
      ..objectiveHashes =
          (json['objectiveHashes'] as List<dynamic>?)
              ?.map((e) => (e as num).toInt())
              .toList()
      ..recordValueStyle = decodeDestinyRecordValueStyle(
...
Map<String, dynamic> _$DestinyRecordDefinitionToJson(
  ...
  'recordValueStyle': encodeDestinyRecordValueStyle(instance.recordValueStyle),
