...
class DestinyReportReasonCategoryDefinition{	
	...
	static Future<DestinyReportReasonCategoryDefinition> asyncFromJson(Map<String, dynamic> json) => 
		compute<Map<String, dynamic>, DestinyReportReasonCategoryDefinition>((json)=>DestinyReportReasonCategoryDefinition.fromJson(json), json);
