...
class DestinyTalentNodeStatBlock{	
	...
	static Future<DestinyTalentNodeStatBlock> asyncFromJson(Map<String, dynamic> json) => 
		compute<Map<String, dynamic>, DestinyTalentNodeStatBlock>((json)=>DestinyTalentNodeStatBlock.fromJson(json), json);
