...
GroupPotentialMembershipSearchResponse
    _$GroupPotentialMembershipSearchResponseFromJson(
        Map<String, dynamic> json) {
  return GroupPotentialMembershipSearchResponse()
    ..results = (json['results'] as List<dynamic>?)
        ?.map(
            (e) => GroupPotentialMembership.fromJson(e as Map<String, dynamic>))
        .toList()
