    ...
    DestinyVendorInteractionDefinition()
      ...
      ..replies =
          (json['replies'] as List<dynamic>?)
              ?.map(
                (e) => DestinyVendorInteractionReplyDefinition.fromJson(
      ...
      ..sackInteractionList =
          (json['sackInteractionList'] as List<dynamic>?)
              ?.map(
                (e) => DestinyVendorInteractionSackEntryDefinition.fromJson(
                  e as Map<String, dynamic>,
                ),
              )
              .toList()
      ...
      ..headerDisplayProperties =
          json['headerDisplayProperties'] == null
              ? null
