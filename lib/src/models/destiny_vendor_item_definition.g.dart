    ...
    DestinyVendorItemDefinition()
      ...
      ..currencies =
          (json['currencies'] as List<dynamic>?)
              ?.map(
                (e) => DestinyVendorItemQuantity.fromJson(
      ...
      ..creationLevels =
          (json['creationLevels'] as List<dynamic>?)
              ?.map(
                (e) => DestinyItemCreationEntryLevelDefinition.fromJson(
                  e as Map<String, dynamic>,
                ),
              )
              .toList()
      ...
      ..redirectToSaleIndexes =
          (json['redirectToSaleIndexes'] as List<dynamic>?)
              ...
              .toList()
      ..socketOverrides =
          (json['socketOverrides'] as List<dynamic>?)
              ?.map(
                (e) => DestinyVendorItemSocketOverride.fromJson(
                  e as Map<String, dynamic>,
                ),
              )
              .toList()
...
Map<String, dynamic> _$DestinyVendorItemDefinitionToJson(
  ...
  'creationLevels': instance.creationLevels?.map((e) => e.toJson()).toList(),
  ...
  'socketOverrides': instance.socketOverrides?.map((e) => e.toJson()).toList(),
