...
DestinyInventoryItemDefinition _$DestinyInventoryItemDefinitionFromJson(
  ...
  return DestinyInventoryItemDefinition()
    ...
    ..tooltipNotifications = (json['tooltipNotifications'] as List<dynamic>?)
        ?.map((e) =>
            DestinyItemTooltipNotification.fromJson(e as Map<String, dynamic>))
        .toList()
    ...
    ..perks = (json['perks'] as List<dynamic>?)
        ?.map((e) =>
            DestinyItemPerkEntryDefinition.fromJson(e as Map<String, dynamic>))
        .toList()
    ...
    ..itemCategoryHashes = (json['itemCategoryHashes'] as List<dynamic>?)
        ?.map((e) => e as int)
        .toList()
    ..specialItemType = _$enumDecodeNullable(
        _$SpecialItemTypeEnumMap, json['specialItemType'],
        unknownValue: SpecialItemType.ProtectedInvalidEnumValue)
    ..itemType = _$enumDecodeNullable(
        _$DestinyItemTypeEnumMap, json['itemType'],
        unknownValue: DestinyItemType.ProtectedInvalidEnumValue)
    ..itemSubType = _$enumDecodeNullable(
        _$DestinyItemSubTypeEnumMap, json['itemSubType'],
    ...
    ..breakerType = _$enumDecodeNullable(
        _$DestinyBreakerTypeEnumMap, json['breakerType'],
    ...
    ..damageTypes = (json['damageTypes'] as List<dynamic>?)
        ...
        .toList()
    ..defaultDamageType = _$enumDecodeNullable(
        _$DamageTypeEnumMap, json['defaultDamageType'],
