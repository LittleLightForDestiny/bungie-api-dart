...
class DestinyMilestone{	
	...
	static Future<DestinyMilestone> asyncFromJson(Map<String, dynamic> json) => 
		compute<Map<String, dynamic>, DestinyMilestone>((json)=>DestinyMilestone.fromJson(json), json);
