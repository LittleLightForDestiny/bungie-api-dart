...
DestinyActivityGraphNodeDefinition _$DestinyActivityGraphNodeDefinitionFromJson(
  Map<String, dynamic> json,
    ...
    DestinyActivityGraphNodeDefinition()
      ...
      ..featuringStates =
          (json['featuringStates'] as List<dynamic>?)
              ?.map(
                (e) =>
      ...
      ..activities =
          (json['activities'] as List<dynamic>?)
              ?.map(
                (e) => DestinyActivityGraphNodeActivityDefinition.fromJson(
                  e as Map<String, dynamic>,
                ),
              )
              .toList()
      ..states =
          (json['states'] as List<dynamic>?)
              ?.map(
                (e) => DestinyActivityGraphNodeStateEntry.fromJson(
                  e as Map<String, dynamic>,
                ),
              )
              .toList();
...
Map<String, dynamic> _$DestinyActivityGraphNodeDefinitionToJson(
  ...
  'featuringStates': instance.featuringStates?.map((e) => e.toJson()).toList(),
