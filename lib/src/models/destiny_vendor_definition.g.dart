...
DestinyVendorDefinition _$DestinyVendorDefinitionFromJson(
  Map<String, dynamic> json,
    ...
    DestinyVendorDefinition()
      ...
      ..vendorProgressionType = decodeDestinyVendorProgressionType(
      ...
      ..failureStrings =
          (json['failureStrings'] as List<dynamic>?)
              ?.map((e) => e as String)
              .toList()
      ..unlockRanges =
          (json['unlockRanges'] as List<dynamic>?)
      ...
      ..actions =
          (json['actions'] as List<dynamic>?)
              ?.map(
                (e) => DestinyVendorActionDefinition.fromJson(
      ...
      ..categories =
          (json['categories'] as List<dynamic>?)
              ?.map(
                (e) => DestinyVendorCategoryEntryDefinition.fromJson(
                  e as Map<String, dynamic>,
                ),
              )
              .toList()
      ..originalCategories =
          (json['originalCategories'] as List<dynamic>?)
              ?.map(
                (e) => DestinyVendorCategoryEntryDefinition.fromJson(
                  e as Map<String, dynamic>,
                ),
              ...
              .toList()
      ..displayCategories =
          (json['displayCategories'] as List<dynamic>?)
              ?.map(
                (e) => DestinyDisplayCategoryDefinition.fromJson(
                  e as Map<String, dynamic>,
                ),
              )
              .toList()
      ..interactions =
          (json['interactions'] as List<dynamic>?)
              ?.map(
                (e) => DestinyVendorInteractionDefinition.fromJson(
                  e as Map<String, dynamic>,
                ),
              )
              .toList()
      ..inventoryFlyouts =
          (json['inventoryFlyouts'] as List<dynamic>?)
              ?.map(
                (e) => DestinyVendorInventoryFlyoutDefinition.fromJson(
                  e as Map<String, dynamic>,
                ),
              )
              .toList()
      ..itemList =
          (json['itemList'] as List<dynamic>?)
              ?.map(
                (e) => DestinyVendorItemDefinition.fromJson(
                  e as Map<String, dynamic>,
                ),
              )
              .toList()
      ..services =
          (json['services'] as List<dynamic>?)
              ?.map(
                (e) => DestinyVendorServiceDefinition.fromJson(
                  e as Map<String, dynamic>,
                ),
              )
              .toList()
      ..acceptedItems =
          (json['acceptedItems'] as List<dynamic>?)
              ?.map(
                (e) => DestinyVendorAcceptedItemDefinition.fromJson(
                  e as Map<String, dynamic>,
                ),
              )
              .toList()
      ...
      ..locations =
          (json['locations'] as List<dynamic>?)
              ?.map(
                (e) => DestinyVendorLocationDefinition.fromJson(
                  e as Map<String, dynamic>,
                ),
              )
              .toList()
      ..groups =
          (json['groups'] as List<dynamic>?)
              ?.map(
                (e) => DestinyVendorGroupReference.fromJson(
                  e as Map<String, dynamic>,
                ),
              )
              .toList()
      ..ignoreSaleItemHashes =
          (json['ignoreSaleItemHashes'] as List<dynamic>?)
...
Map<String, dynamic> _$DestinyVendorDefinitionToJson(
  ...
  'vendorProgressionType': encodeDestinyVendorProgressionType(
    instance.vendorProgressionType,
  ),
