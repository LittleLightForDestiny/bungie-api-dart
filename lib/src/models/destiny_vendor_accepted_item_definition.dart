...
class DestinyVendorAcceptedItemDefinition{	
	...
	factory DestinyVendorAcceptedItemDefinition.fromJson(Map<String, dynamic> json) {
		return _$DestinyVendorAcceptedItemDefinitionFromJson(json);
	}
	
	Map<String, dynamic> toJson() => _$DestinyVendorAcceptedItemDefinitionToJson(this);

	static Future<DestinyVendorAcceptedItemDefinition> asyncFromJson(Map<String, dynamic> json) => 
		compute<Map<String, dynamic>, DestinyVendorAcceptedItemDefinition>((json)=>DestinyVendorAcceptedItemDefinition.fromJson(json), json);
