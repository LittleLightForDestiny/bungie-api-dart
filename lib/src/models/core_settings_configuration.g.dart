...
CoreSettingsConfiguration _$CoreSettingsConfigurationFromJson(
  Map<String, dynamic> json,
    ...
    CoreSettingsConfiguration()
      ...
      ..ignoreReasons =
          (json['ignoreReasons'] as List<dynamic>?)
              ?.map((e) => CoreSetting.fromJson(e as Map<String, dynamic>))
              .toList()
      ..forumCategories =
          (json['forumCategories'] as List<dynamic>?)
              ?.map((e) => CoreSetting.fromJson(e as Map<String, dynamic>))
              .toList()
      ..groupAvatars =
          (json['groupAvatars'] as List<dynamic>?)
              ?.map((e) => CoreSetting.fromJson(e as Map<String, dynamic>))
              .toList()
      ..defaultGroupTheme =
          json['defaultGroupTheme'] == null
              ? null
      ...
      ..recruitmentPlatformTags =
          (json['recruitmentPlatformTags'] as List<dynamic>?)
              ...
              .toList()
      ..recruitmentMiscTags =
          (json['recruitmentMiscTags'] as List<dynamic>?)
              ?.map((e) => CoreSetting.fromJson(e as Map<String, dynamic>))
              .toList()
      ..recruitmentActivities =
          (json['recruitmentActivities'] as List<dynamic>?)
              ...
              .toList()
      ..userContentLocales =
          (json['userContentLocales'] as List<dynamic>?)
              ?.map((e) => CoreSetting.fromJson(e as Map<String, dynamic>))
              .toList()
      ..systemContentLocales =
          (json['systemContentLocales'] as List<dynamic>?)
              ?.map((e) => CoreSetting.fromJson(e as Map<String, dynamic>))
              .toList()
      ..clanBannerDecals =
          (json['clanBannerDecals'] as List<dynamic>?)
              ?.map((e) => CoreSetting.fromJson(e as Map<String, dynamic>))
              .toList()
      ..clanBannerDecalColors =
          (json['clanBannerDecalColors'] as List<dynamic>?)
              ...
              .toList()
      ..clanBannerGonfalons =
          (json['clanBannerGonfalons'] as List<dynamic>?)
              ?.map((e) => CoreSetting.fromJson(e as Map<String, dynamic>))
              .toList()
...
Map<String, dynamic> _$CoreSettingsConfigurationToJson(
  ...
  'forumCategories': instance.forumCategories?.map((e) => e.toJson()).toList(),
  ...
  'clanBannerGonfalonDetailColors':
      instance.clanBannerGonfalonDetailColors?.map((e) => e.toJson()).toList(),
  'clanBannerStandards':
