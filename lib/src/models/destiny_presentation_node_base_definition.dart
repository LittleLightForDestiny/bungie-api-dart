...
class DestinyPresentationNodeBaseDefinition{	
	...
	static Future<DestinyPresentationNodeBaseDefinition> asyncFromJson(Map<String, dynamic> json) => 
		compute<Map<String, dynamic>, DestinyPresentationNodeBaseDefinition>((json)=>DestinyPresentationNodeBaseDefinition.fromJson(json), json);
