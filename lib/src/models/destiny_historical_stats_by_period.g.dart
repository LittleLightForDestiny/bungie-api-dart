...
Map<String, dynamic> _$DestinyHistoricalStatsByPeriodToJson(
  ...
  'allTimeTier1': instance.allTimeTier1?.map((k, e) => MapEntry(k, e.toJson())),
  'allTimeTier2': instance.allTimeTier2?.map((k, e) => MapEntry(k, e.toJson())),
  'allTimeTier3': instance.allTimeTier3?.map((k, e) => MapEntry(k, e.toJson())),
