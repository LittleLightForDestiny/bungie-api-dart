  ...
  Map<String, dynamic> json,
    ...
    DestinyDestinationDefinition()
      ...
      ..activityGraphEntries =
          (json['activityGraphEntries'] as List<dynamic>?)
              ?.map(
              ...
              .toList()
      ..bubbleSettings =
          (json['bubbleSettings'] as List<dynamic>?)
              ?.map(
                (e) => DestinyDestinationBubbleSettingDefinition.fromJson(
                  e as Map<String, dynamic>,
                ),
              )
              .toList()
      ..bubbles =
          (json['bubbles'] as List<dynamic>?)
              ?.map(
                (e) =>
...
Map<String, dynamic> _$DestinyDestinationDefinitionToJson(
  ...
  'bubbleSettings': instance.bubbleSettings?.map((e) => e.toJson()).toList(),
