...
class OAuth{
  static void openOAuth(OAuthBrowser browser, String clientId, [String languageCode = 'en', bool reauth=false]){
  ...
  static Future<BungieNetToken> getToken(HttpClient client, String clientId, String clientSecret, String code){
    final HttpClientConfig config = HttpClientConfig('POST', '/App/OAuth/token/', null);
