...
class FireteamResponseResponse extends BungieNetResponse<FireteamResponse> {
	...
	static Future<FireteamResponseResponse> asyncFromJson(Map<String, dynamic> json) => 
		compute<Map<String, dynamic>, FireteamResponseResponse>((json)=>FireteamResponseResponse.fromJson(json), json);
