...
class SearchResultOfContentItemPublicContractResponse extends BungieNetResponse<SearchResultOfContentItemPublicContract> {
	...
	static Future<SearchResultOfContentItemPublicContractResponse> asyncFromJson(Map<String, dynamic> json) => 
		compute<Map<String, dynamic>, SearchResultOfContentItemPublicContractResponse>((json)=>SearchResultOfContentItemPublicContractResponse.fromJson(json), json);
