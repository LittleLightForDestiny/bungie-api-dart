...
@JsonSerializable()
class GroupMembershipSearchResponseResponse extends BungieNetResponse<GroupMembershipSearchResponse> {
	...
	static Future<GroupMembershipSearchResponseResponse> asyncFromJson(Map<String, dynamic> json) => 
		compute<Map<String, dynamic>, GroupMembershipSearchResponseResponse>((json)=>GroupMembershipSearchResponseResponse.fromJson(json), json);
