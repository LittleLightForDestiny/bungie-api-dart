...
class DestinyCharacterResponseResponse extends BungieNetResponse<DestinyCharacterResponse> {
	...
	static Future<DestinyCharacterResponseResponse> asyncFromJson(Map<String, dynamic> json) => 
		compute<Map<String, dynamic>, DestinyCharacterResponseResponse>((json)=>DestinyCharacterResponseResponse.fromJson(json), json);
