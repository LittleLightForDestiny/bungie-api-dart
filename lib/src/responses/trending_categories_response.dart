...
class TrendingCategoriesResponse extends BungieNetResponse<TrendingCategories> {
	...
	static Future<TrendingCategoriesResponse> asyncFromJson(Map<String, dynamic> json) => 
		compute<Map<String, dynamic>, TrendingCategoriesResponse>((json)=>TrendingCategoriesResponse.fromJson(json), json);
