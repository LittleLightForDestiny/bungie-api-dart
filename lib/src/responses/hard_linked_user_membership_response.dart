...
class HardLinkedUserMembershipResponse extends BungieNetResponse<HardLinkedUserMembership> {
	...
	static Future<HardLinkedUserMembershipResponse> asyncFromJson(Map<String, dynamic> json) => 
		compute<Map<String, dynamic>, HardLinkedUserMembershipResponse>((json)=>HardLinkedUserMembershipResponse.fromJson(json), json);
